...
### Kakao Bot에 관하여
먼저 공자사항 - 이런 데다가 GPT 쓰면 안 됩니다. 웹 검색과 reference에 크게 의존하기 때문에 GPT가 똑바로 검색하지 못할 가능성이 농후합니다. Kakao Developers reference 버젓히 있는데 GPT한테 물어보고 안 된다고 찡찡대면 제가 좀 힘들겠죠.
